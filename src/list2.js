...
export default function List2() {
    const [list, setList] = useState(["PARIS", "DELHI"]);
      ...
      return (
        ...
        <div>
          <h2 style={{marginTop:"0px",color:"#4ECDC4"}}>Favourite Destination</h2>
          <input type="text" id="ip2" placeholder="Enter Destination" />&nbsp; &nbsp;
          <button onClick={add} className="bt">Add Destination</button>
