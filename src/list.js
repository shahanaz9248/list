...
function List() {
  const [list, setList] = useState(["JAPANESE", "ITALIAN"]);
  ...
  return (
    ...
    <div>
      <h2 style={{marginTop:"0px",color:"#4ECDC4"}}>Favourite Cuisine</h2>
      <input type="text" id="ip" placeholder="Enter Cuisine" />&nbsp; &nbsp;
      <button onClick={add} className="bt">Add Cuisine</button>
